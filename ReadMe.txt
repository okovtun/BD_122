...
TODO:
1. По завершении программы результирующий файл должен открыватся в блокноте;
2. Имя исходного и результирующего файлов должны вводиться с клавиатуры;
...
bool is_int_number(char str[]);	//Проверяет, является ли стока целым десятичным числом
bool is_bin_number(char str[]);	//Проверяет, является ли стока двоичным числом
bool is_hex_number(char str[]);	//Проверяет, является ли стока шестнадцатеричным числом

int string_to_int(char str[]);	//Если строка является целым десятичным числом, функция возвращает его десятичное значение
int bin_to_int(char str[]);		//Если строка является двоичным числом, функция возвращает его десятичное значение
int hex_to_int(char str[]);		//Если строка является шестнадцатеричным числом, функция возвращает его десятичное значение
